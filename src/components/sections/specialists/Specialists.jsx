      ...
      <div className="container">
        <div className={style.section_specialists}>
          ...
          <div className={style.content_block}>
            ...
            <h1 style={{ margin: '32px 0 0' }} className='title_black'>
          ...
          <div className={style.specialists_block}>
            ...
            <ul className={style.specialists_list}>
              <li className={style.list_item}>
                ...
                <h5 style={{margin: '24px 0 16px 0'}} className='h5_text'>КИРИЛЛ АЛЕКСАНДРОВич</h5>
                <p className='light_gray_text'>27 лет стажа</p>
              </li>

              <li className={style.list_item}>
                <h5 className='h5_text'>Любовь Юрьевна</h5>
                <p style={{margin: '16px 0 24px 0'}} className='light_gray_text'>18 лет стажа</p>
              ...
              <li className={style.list_item}>
                ...
                <h5 style={{margin: '24px 0 16px 0'}} className='h5_text'>Иван васильевич</h5>
                <p className='light_gray_text'>17 лет стажа</p>
              </li>

              <li className={style.list_item}>
                <h5 className='h5_text'>АННА ДМИТРИЕВНА</h5>
                <p style={{margin: '16px 0 24px 0'}} className='light_gray_text'>14 лет стажа</p>
